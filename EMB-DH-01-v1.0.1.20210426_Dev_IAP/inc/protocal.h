...
//#define parameters_flash_address  0x0803f800
...
typedef __packed struct
{
	parameter_data_struct parameter_data;
	version_data_struct   version_data;
	uint16_t              check_sum;	
...
typedef __packed union
{
	...
	__packed union
	{
		parameter_data_send_struct      parameter_data_send;	
		parameter_data_receive_struct   parameter_data_receive;
	};
}frame_union;
